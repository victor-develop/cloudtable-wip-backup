...
| `invited_member_reactive_read_parity_contract` | invited-member reactive saved-view readback and persona-preview parity | `testing/cloudtable/suites/regression/mvp-regression-matrix.spec.ts` |
