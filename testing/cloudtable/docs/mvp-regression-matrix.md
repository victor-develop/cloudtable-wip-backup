...
| `workflow_scheduled_dispatch_payload_determinism` | scheduled workflow delivery recovery | `testing/cloudtable/suites/invariants/determinism.spec.ts`, `testing/cloudtable/suites/regression/mvp-regression-matrix.spec.ts`, `testing/cloudtable/suites/runtime/ingress.spec.ts`, `testing/cloudtable/suites/runtime/queue-consumer.spec.ts` |
...
| `invitation_backed_reactive_sync_contract` | identity and reactive workflow integration | `testing/cloudtable/suites/regression/mvp-regression-matrix.spec.ts`, `testing/cloudtable/suites/runtime/ingress.spec.ts`, `testing/cloudtable/suites/runtime/queue-consumer.spec.ts` |
| `cross_org_invited_member_workspace_selection_reactive_contract` | cross-organization invited-member workspace selection and reactive workflow integration | `testing/cloudtable/suites/regression/mvp-regression-matrix.spec.ts`, `testing/cloudtable/suites/runtime/ingress.spec.ts` |
| `invited_member_reactive_read_parity_contract` | invited-member reactive saved-view readback and persona-preview parity | `testing/cloudtable/suites/regression/mvp-regression-matrix.spec.ts`, `testing/cloudtable/suites/runtime/ingress.spec.ts` |
| `workflow_service_identity_reactive_maintenance_writes` | workflow service-identity audit metadata on reactive maintenance writes and fail-closed behavior when explicit metadata is missing | `testing/cloudtable/suites/regression/mvp-regression-matrix.spec.ts`, `testing/cloudtable/suites/runtime/queue-consumer.spec.ts`, `testing/cloudtable/suites/runtime/ingress.spec.ts` |
| `shared_idempotency_key_isolated_by_scope` | idempotency and scope isolation | `testing/cloudtable/suites/invariants/determinism.spec.ts`, `testing/cloudtable/suites/regression/mvp-regression-matrix.spec.ts`, `testing/cloudtable/suites/command-golden/command-bus.spec.ts` |
