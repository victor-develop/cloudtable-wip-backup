# CloudTable Identity/Reactive Reconciliation - CLO-1829
...
The code and issue state still match the CLO-1827 checkpoint. The tracked repo
...
material change after CLO-1827 that would justify creating a duplicate
...
The active driver CLO-1828 is blocked by this checkpoint only. The broader goal
state has not introduced a newer active non-driver implementation, QA, product,
or design lane after CLO-1827.
...
Close CLO-1829 as done and unblock CLO-1828. Do not create a duplicate
